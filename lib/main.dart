...
class _MyHomePageState extends State<MyHomePage> {
        ...
        slivers: <Widget>[
          ...
          SliverGrid(
            ...
            delegate: SliverChildListDelegate(
              [
                _buildGridItem(
                    'assets/images/game1.jpg', 'MaiQuinn', '@MAIQUINNVNLE'),
                _buildGridItem('assets/images/game2.jpg', 'Host Nguyen',
                    '@hostnguyenkhang'),
                _buildGridItem(
                    'assets/images/game3.jpg', 'Thieu Rino', '@ThieuRino'),
                _buildGridItem(
                    'assets/images/game4.jpg', 'Firefly', '@firefly'),
                _buildGridItem('assets/images/game5.jpg', 'Stelle', '@stelle'),
                _buildGridItem('assets/images/game1.jpg',
  ...
  Widget _buildGridItem(String imagePath, String name, String userId) {
    return Container(
      color: Colors.white,
      height: 140.0,
      width: 80.0,
